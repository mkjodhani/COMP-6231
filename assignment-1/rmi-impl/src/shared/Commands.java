...
public class Commands {
    ...
    public static final String addMovieTickets(String customerID, String movieID, String movieName, int numberOfTickets) {
        String[] args = new String[]{BOOK_MOVIE_TICKET,customerID,movieID,movieName,String.valueOf(numberOfTickets)};
        return Commands.generateCommandFromParams(args);
    }
    public static final String cancelMovieTickets(String customerID, String movieID, String movieName, int numberOfTickets) {
