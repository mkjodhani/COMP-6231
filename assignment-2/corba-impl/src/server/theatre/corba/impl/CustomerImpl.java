...
import org.omg.CORBA.CustomerPOA;
...
public class CustomerImpl extends CustomerPOA {
    ...
    @Override
    synchronized public String exchangeTickets(String customerID, String oldMovieName, String movieID, String newMovieID, String newMovieName, int numberOfTickets) {
