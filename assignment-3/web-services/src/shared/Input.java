...
public class Input {
    ...
    public static final String getRemoteObjectIdByPrefix(String prefix,String object){
        return prefix + "_" + object;
    }
    private static final String getNextDateFromID(String slotId){
        int day = Integer.parseInt(slotId.substring(4,6)) , month = Integer.parseInt(slotId.substring(6,8)) -1, year = Integer.parseInt(slotId.substring(8,10)) + 2000;
    ...
    public static final boolean isValidMovieId(String slotId){
        try {
            ...
            if(!"atw-ver-out".contains(slotId.substring(0,3))){
                return false;
            }
            // valid slot time (Morning-Afternoon-Evening)
            if(!"m,a,e".contains(slotId.substring(3,4))){
                return false;
            }
